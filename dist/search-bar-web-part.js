...
>>>>>>> a6d263c9b867579b548c038928fbc9aaddbbff6c
...
<<<<<<< HEAD
        var url = "".concat(this.context.pageContext.web.absoluteUrl, "/_api/web/lists/getByTitle('").concat(documentLibrary, "')/items?$select=FileLeafRef,Thumbnail");
=======
        var url = "".concat(this.context.pageContext.web.absoluteUrl, "/_api/web/lists/getByTitle('").concat(documentLibrary, "')/items?$select=Author");
>>>>>>> a6d263c9b867579b548c038928fbc9aaddbbff6c
        console.log(url);
...
=======
                        var fileLeafRef = ((_b = (_a = properties.getElementsByTagName('d:FileLeafRef')[0]) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.trim()) || '';
                        var description = ((_d = (_c = properties.getElementsByTagName('d:Description')[0]) === null || _c === void 0 ? void 0 : _c.textContent) === null || _d === void 0 ? void 0 : _d.trim()) || 'No description available';
                        documents.push({
...
<<<<<<< HEAD
            _this.renderSearchResults(files);
=======
            _this.renderSearchResults(documents);
>>>>>>> a6d263c9b867579b548c038928fbc9aaddbbff6c
        })
...
<<<<<<< HEAD
    SearchBarWebPart.prototype.renderSearchResults = function (files) {
=======
    SearchBarWebPart.prototype.renderSearchResults = function (documents) {
>>>>>>> a6d263c9b867579b548c038928fbc9aaddbbff6c
        var _this = this;
...
<<<<<<< HEAD
        files.forEach(function (file) {
            ...
            var fileUrl = "".concat(_this.context.pageContext.web.absoluteUrl, "/DocLib5/Forms/AllItems.aspx?id=%2Fsites%2Fmsteams_274b5c%2FDocLib5%2F").concat(encodeURIComponent(file.name), "&parent=%2Fsites%2Fmsteams_274b5c%2FDocLib5");
            // Construct the HTML for each document with preview image
            html += "\n          <div class=\"".concat(_SearchBarWebPart_module_scss__WEBPACK_IMPORTED_MODULE_4__[/* default */ "e"].document, "\" id=\"document\">\n              <div class=\"").concat(_SearchBarWebPart_module_scss__WEBPACK_IMPORTED_MODULE_4__[/* default */ "e"].preview, "\" id=\"preview\">\n                  <img src=\"").concat(file.thumbnailUrl, "\" alt=\"File Preview\">\n              </div>\n              <div id=\"details\" class=\"").concat(_SearchBarWebPart_module_scss__WEBPACK_IMPORTED_MODULE_4__[/* default */ "e"].details, "\" >\n                  <a href=\"").concat(fileUrl, "\" target=\"_blank\">").concat(file.name, "</a>\n                  <!-- You can add more details here if needed -->\n              </div>\n          </div>\n      ");
=======
        documents.forEach(function (document) {
            // Construct the URL for each file
            var fileUrl = "".concat(_this.context.pageContext.web.absoluteUrl, "/DocLib/Forms/AllItems.aspx?id=%2Fsites%2Ftest440%2FDocLib%2F").concat(encodeURIComponent(document.fileLeafRef), "&parent=%2Fsites%2Ftest440%2FDocLib");
            var previewImageUrl = "dswercv";
            // Replace 'Document Title' with the actual document title
            var documentTitle = document.fileLeafRef; // Replace this with the actual title
            // Replace 'Description or additional details' with the actual description
            var documentDescription = document.description; // Replace this with the actual description
            // Construct the HTML for each document
            html += "\n        <div class=\"".concat(_SearchBarWebPart_module_scss__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].document, "\">\n          <div class=\"").concat(_SearchBarWebPart_module_scss__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].preview, "\">\n            <img src=\"").concat(previewImageUrl, "\" alt=\"File Preview\">\n          </div>\n          <div class=\"").concat(_SearchBarWebPart_module_scss__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].details, "\">\n            <a href=\"").concat(fileUrl, "\" target=\"_blank\">").concat(documentTitle, "</a>\n            <p>").concat(documentDescription, "</p>\n          </div>\n        </div>\n      ");
>>>>>>> a6d263c9b867579b548c038928fbc9aaddbbff6c
        });
